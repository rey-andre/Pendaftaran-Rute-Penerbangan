...
Ini adalah sebuah website Pendaftaran Rute Penerbangan sederhana yang dibuat menggunakan PHP dan JSON sebagai penyimpan datanya.

## Features
- Menampilkan data - data Rute Penerbangan
- Menginput data Rute Penerbangan
- Menghitung pajak dari bandara
- Menghitung harga total tiket penerbangan
